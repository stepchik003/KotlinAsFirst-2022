 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = round(sagenes * 48 * 4.445 + arshins * 16 * 4.445 + vershoks * 4.445)/100
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = round(((deg + (min.toDouble() + sec.toDouble()/60)/60)  * 0.0174533)*100000)/100000
